...
const pacienteContactoRoutes = require('./routes/pacienteContacto.routes');
...
const adjuntoHistoriaClinicaRoutes = require('./routes/adjuntoHistoriaClinica.routes');
...
app.use('/api/roles-permisos', rolePermissionRoutes);
app.use('/api/contactos', contactoRoutes);
app.use('/api/pacientes/:pacienteId/contactos', pacienteContactoRoutes);
...
app.use('/api/finanzas/movimientos-caja', movimientoCajaRoutes);
