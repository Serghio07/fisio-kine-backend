...
HistoriaClinica.hasMany(Cita, { foreignKey: 'historia_clinica_id', as: 'programaciones', onDelete: 'RESTRICT' });
Cita.belongsTo(HistoriaClinica, { foreignKey: 'historia_clinica_id', as: 'historia_clinica', onDelete: 'RESTRICT' });
Usuario.hasMany(Cita, { foreignKey: 'profesional_id', as: 'agenda_profesional', onDelete: 'SET NULL' });
Cita.belongsTo(Usuario, { foreignKey: 'profesional_id', as: 'profesional', onDelete: 'SET NULL' });
Sesion.hasOne(Cita, { foreignKey: 'sesion_id', as: 'programacion', onDelete: 'RESTRICT' });
Cita.belongsTo(Sesion, { foreignKey: 'sesion_id', as: 'sesion_clinica', onDelete: 'RESTRICT' });
