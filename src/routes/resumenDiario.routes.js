...
const { bloquearSeccionFinanciera, filtrarRespuestaFinanciera } = require('../middlewares/financialAccess.middleware');
const controller = require('../controllers/resumenDiario.controller');

router.use(autenticar, filtrarRespuestaFinanciera);
router.get('/', bloquearSeccionFinanciera, controller.obtenerResumenDiario);
